...
const NewCard: React.FC = ({}) => {
	...
	const [subCategorysArray, setSubCategorysArray] = useState<OptionType>()
	...
	// useEffect(() => {
	// 	const ThisCat = subCategorysArray?.data.find(
	// 		(item) => item == underCategoryState
	// 	)
	// 	if (ThisCat.newOld == true) {
	...
	return (
		...
		// 			{subCategorysArray && (
		// 				<Autocomplete
		// 					options={subCategorysArray?.data as OptionType[]}
		...
		// 							value !== null
		// 						) {
		// 							return option.catName === value.catName
		// 						}
		...
		// 					>
		// 						{photoStates?.length
		// 							? `Нажмите или перетащите новую фотографию в окно ниже, уже ${phoneState.length} загружено`
